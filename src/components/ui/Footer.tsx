                            ...
                            <div className="mb-10 w-full">
                                ...
                                <div className="mb-6 flex items-center">
                                    <a
                                        ...
                                        className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke hover:border-primary-400 hover:bg-primary-400 hover:text-white  sm:mr-4 lg:mr-3 xl:mr-4"
                                    >
                                        <svg
                                            width="8"
                                            height="16"
